...
BitcoinTerminology = {
    ...
    "M.2":"M.2 is a compact form factor designed to connect SSDs and other expansion cards directly to a motherboard. It supports both NVMe and SATA protocols, depending on the drive and motherboard configuration",
